...
- [X] T001 Add new dependencies to requirements.txt: llama-cpp-python, paho-mqtt==1.6.0, pyyaml
- [X] T002 Download Phi-4-Mini-GGUF Q4_K_M model (~2GB) to models/Phi-4-Mini-GGUF/
- [X] T003 [P] Create config/devices.yaml.example with sample device mappings
- [X] T004 [P] Create .env.example with MQTT broker and SLM configuration variables
- [X] T005 [P] Create src/command/ directory for SLM integration module
- [X] T006 [P] Create src/devices/ directory for device mapping and MQTT module
- [X] T007 [P] Create tests/contract/ directory for contract tests
- [X] T008 [P] Create config/ directory for configuration files

**Checkpoint**: Project structure ready for implementation ✅ COMPLETE
...
- [X] T009 [P] [FOUND] Implement DeviceConfig class in src/devices/config.py to load YAML
...
- [X] T010 [P] [FOUND] Implement MQTTConfig class in src/devices/mqtt_config.py
...
- [X] T011 [P] [FOUND] Create exception hierarchy in src/utils/exceptions.py
...
- [X] T012 [P] [FOUND] Create Command dataclass in src/command/models.py
...
- [X] T013 [P] [FOUND] Create DeviceMapping dataclass in src/devices/models.py
...
- [X] T014 [P] [FOUND] Create MQTTMessage dataclass in src/devices/models.py
  - Attributes: topic (str), payload (dict), qos (int), timestamp (datetime)
  - JSON payload serialization
  - QoS validation (0, 1, 2)

- [X] T015 [P] [FOUND] Create DeviceState dataclass in src/devices/state.py
...
- [X] T016 [P] [FOUND] Create CommandSession dataclass in src/command/session.py
...
- [X] T017 [P] [US1] Contract test for SLMEngine in tests/contract/test_slm_interface.py
...
- [X] T018 [P] [US1] Integration test for text-to-command pipeline in tests/integration/test_command_extraction.py
...
- [X] T019 [US1] Implement SLMEngine class in src/command/slm_engine.py
...
- [X] T020 [US1] Implement extract_command method in SLMEngine (src/command/slm_engine.py)
...
- [X] T021 [US1] Implement prompt template in src/command/prompts.py
...
- [X] T022 [US1] Implement CommandParser class in src/command/parser.py
...
- [X] T023 [US1] Add command extraction logging in src/command/parser.py
...
**Checkpoint**: Text input → Command extraction working independently ✅ COMPLETE
...
- [X] T024 [P] [US2] Contract test for MQTTClient in tests/contract/test_mqtt_publisher.py
...
- [X] T025 [P] [US2] Integration test for command-to-MQTT pipeline in tests/integration/test_mqtt_publishing.py
...
- [X] T026 [US2] Implement MQTTClient class in src/devices/mqtt_client.py
...
- [X] T027 [US2] Implement publish_command method in MQTTClient (src/devices/mqtt_client.py)
...
- [X] T028 [US2] Implement payload builders in src/devices/payload.py
...
- [X] T029 [US2] Implement disconnect and cleanup in MQTTClient (src/devices/mqtt_client.py)
  - disconnect() method for graceful shutdown
  - Flush pending messages before disconnecting
  - Clear connection state
  - Log disconnection event

- [X] T030 [US2] Implement CommandRouter class in src/command/router.py
...
- [X] T031 [US2] Add MQTT logging in src/devices/mqtt_client.py
...
- [X] T032 [P] [US3] Contract test for state subscription in tests/contract/test_mqtt_state.py
...
- [X] T033 [P] [US3] Integration test for state-aware commands in tests/integration/test_state_awareness.py
...
- [X] T034 [US3] Implement DeviceStateCache class in src/devices/state.py
...
- [X] T035 [US3] Implement state subscription in MQTTClient (src/devices/mqtt_client.py)
...
- [X] T036 [US3] Integrate state awareness in CommandRouter (src/command/router.py)
...
- [X] T037 [US3] Implement get_device_state method in CommandRouter (src/command/router.py)
...
- [X] T038 [US3] Add state awareness logging in src/devices/state.py
...
- [X] T039 [P] [US4] Contract test for feedback generation in tests/contract/test_feedback.py
...
- [X] T040 [US4] Implement FeedbackGenerator in run_full_system.py (inline implementation)
...
- [X] T041 [US4] Integrate feedback in run_full_system.py
...
- [X] T042 [US4] Implement friendly device name mapping in run_full_system.py
...
- [X] T049 Add --enable-commands flag to run_full_system.py CLI
...
- [X] T050 Integrate CommandRouter into run_full_system.py
